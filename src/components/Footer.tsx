  ...
  return (
    ...
    >
      <div className="container-wide">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 pb-12 border-b border-foreground/10">
          {/* Company Info */}
          ...
          {/* Products */}
          <div>
            <h4 className="text-foreground font-heading font-semibold mb-4">Products</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-foreground font-heading font-semibold mb-4">Support</h4>
            <ul className="space-y-2">
          ...
          {/* Account */}
          <div>
            <h4 className="text-foreground font-heading font-semibold mb-4">Account</h4>
            <ul className="space-y-2">
        ...
        <div className="py-8 border-b border-foreground/10">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-foreground font-heading font-semibold">Industries We Serve</span>
          </div>
          <div className="flex flex-wrap gap-2">
            {industries.map((industry) => (
              <span
                key={industry}
                className="px-3 py-1.5 bg-foreground/10 text-foreground/70 text-sm rounded-full"
              >
                {industry}
              </span>
            ))}
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/terms" className="text-foreground/60 text-sm hover:text-foreground transition-colors">
              Terms of Service
            </Link>
            <Link to="/accessibility" className="text-foreground/60 text-sm hover:text-foreground transition-colors">
              Accessibility
            </Link>
          </div>
